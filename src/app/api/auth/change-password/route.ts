...
import { getSession, sign, SESSION_COOKIE, sessionCookieOptions } from '@/lib/auth';
...
export async function POST(req: Request) {
  ...
  res.cookies.set(SESSION_COOKIE, await sign({ ...s, mustChangePassword: false }), sessionCookieOptions);
  return res;
}
